...
def basic_error(input_subs, manual_subs):
    """Takes the generated subtitles and the manual subtitles and compares them. A caption group is considered to be correct if the last word of the caption group and the first word of the next are the same as in the manual subtitles.

    takes:
    input_subs: the generated subtitles as a srt parsed list
    manual_subs: the man-made subtitles we considered to correct

    outputs: amount of correctly created captiongroups
    """
    good = 0
